...
let RbacController = class RbacController {
    ...
    async createRole(body) {
        var _a, _b;
        await this.rbac.ensurePermissions((_a = body.permissions) !== null && _a !== void 0 ? _a : []);
        return this.rbac.createRole(body.name, (_b = body.permissions) !== null && _b !== void 0 ? _b : [], !!body.isSystem);
    }
    async assign(body) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], RbacController.prototype, "assign", null);
